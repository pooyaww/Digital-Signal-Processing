...
figure, subplot(2,1,1);stem(n,x);title('signal x(n), 0 <= n <= 99');xlabel('n')
...
figure, subplot(2,1,1);stem(n1,y1);title('signal x(n), 0 <= n <= 9');xlabel('n')
...
figure, subplot(2,1,1);stem(n2,y2);title('signal x(n), 0 <= n <= 9 + 40 zeros');xlabel('n')
...
figure, subplot(2,1,1);stem(n3,y3);title('signal x(n), 0 <= n <= 9 + 90 zeros');xlabel('n')
